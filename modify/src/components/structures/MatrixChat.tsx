...
import { setTheme, syncSportisThemeOnInit } from "../../theme";
...
export default class MatrixChat extends React.PureComponent<IProps, IState> {
    ...
    public componentDidMount(): void {
        ...
        // Sync Sportis theme after ThemeWatcher is ready (overrides with cookie value)
        syncSportisThemeOnInit().catch((e) => logger.warn("Sportis theme sync failed", e));
